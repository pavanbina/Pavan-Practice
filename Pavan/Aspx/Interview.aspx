<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Interview.aspx.cs" Inherits="Pavan.Aspx.Interview" %>
                        ...
                        reader.onload = function (e) {
                            ...
                            sheet_name_list.forEach(function (y) { /*Iterate through all sheets*/
                                ...
                                $.each(exceljson, function (key, value) {
                                    var dt = exceljson[key]["Date"];
                                    var type = exceljson[key]["Type"];
                                    var amount = exceljson[key]["Amount"];
                                    var project1 = exceljson[key]["Project1"];
                                    var project2 = exceljson[key]["project2"];
                                    //considering two projects
                                    var totalamtbyproject1 = 0;
                                    var totalamtbyproject2 = 0;
                                    //considering two modes
                                    var milestone = exceljson[key]["milestone"];
                                    var timeMaterial = exceljson[key]["timeMaterial"];
                                        //suming up total amount from excelsheet based on project and mode returning total amount of project
                                        if (exceljson.project == preoject1 && exceljson.mode == milestone || timeMaterial) {
                                            totalamtbyproject1 += exceljson.amount;
                                        }
                                        else {
                                            totalamtbyproject2 += exceljson.amount;
                                        }
                                })
